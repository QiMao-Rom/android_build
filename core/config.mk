...
ifneq ($(QIMAO_BUILD),)
include vendor/qimao/config/BoardConfigQimao.mk
endif
...
ifneq ($(QIMAO_BUILD),)
ifneq ($(wildcard device/qimao/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/qimao/sepolicy/common/sepolicy.mk)
endif
endif
